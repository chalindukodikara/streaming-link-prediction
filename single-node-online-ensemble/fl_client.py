    ...
    def run(self):
        while True:
            ...
            if self.iteration_number == 0:
                ...
                logging.info('------------------------- Batch train set: loss: %s -------------------------', str(round(np.mean(losses), 4)))

                logging.info('################ Batch %s: model evalution  ################',
                             self.iteration_number)
                ...
                logging.info(
                    ...
                    round(testing_end_time - testing_start_time, 0))
                logging.info(
