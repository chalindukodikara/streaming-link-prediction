...
from evaluation.evaluation import eval_node_classification, eval_edge_prediction
...
for i in range(args.n_runs):
  ...
  for epoch in range(args.n_epoch):
    ...
    val_auc = eval_edge_prediction(tgn, full_data.edge_idxs, val_data, n_neighbors=NUM_NEIGHBORS)
